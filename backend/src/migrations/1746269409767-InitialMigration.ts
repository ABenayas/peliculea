...
export class InitialMigration1746269409767 implements MigrationInterface {
    name = 'InitialMigration1746269409767'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_movie" ("id" SERIAL NOT NULL, "status" character varying NOT NULL DEFAULT 'pending', "rating" integer, "notes" text, "addedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "movieId" integer, CONSTRAINT "PK_2fe260b71a39352cfebb47ffa4a" PRIMARY KEY ("id"))`);
